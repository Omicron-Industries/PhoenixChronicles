...
class DragController {
    ...
    DragController(ScreenContext ctx, DragControllerState state, GraphEditorState editorState) {
        this.ctx = ctx;
        this.state = state;
    ...
    void updateDraggedNodeScreenPos(double mx, double my, int snap) {
        int cl = ctx.sidebarW();
    ...
    void beginDragUndo(QuestNode capturedNode, int preX, int preY) {
    ...
    void refreshNodeScreenPos(QuestNode node) {
        int cl = ctx.sidebarW();
