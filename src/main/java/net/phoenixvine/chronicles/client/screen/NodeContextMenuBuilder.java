...
class NodeContextMenuBuilder {
    ...
    NodeContextMenuBuilder(ScreenContext ctx, NodeCtxMenuState ctxState, NodeContextMenuBuilderState state,
    ...
    void openCtx(int x, int y, QuestNode node) {
        openCtx(x, y, node, null);
    }

    void openCtx(int x, int y, QuestNode node, @Nullable QuestGroup group) {
