...
public class TutorialOverlayRenderer {
    ...
    public record Colors(int accent, int border, int textFaint, int textDim, int text, int nbordDone) {}

    public record Layout(int width, int height, int sidebarW, int headerH, int toolbarY, int toolbarH) {}
    ...
    public void render(GuiGraphics g, int mx, int my, Font font, Layout layout, Colors colors,
    ...
    public boolean handleClick(double mx, double my, Function<QuestNode, QuestState> stateLookup) {
